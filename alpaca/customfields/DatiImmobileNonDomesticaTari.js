var datiImmobileNonDomesticaTariContainer = ' \
...
var datiImmobileNonDomesticaTariContainerObject = ' \
<script type="text/x-handlebars-template"> \
    <div> \
		<div class="row"> \
...
(function($) {
     ...
     */
    {
        ...
        getFieldType: function() {
            return "datiImmobileNonDomesticaTari";
        },
        ...
        setup: function() {
            ...
            Alpaca.merge(this.options, {
            	...
            	"view": "immobilenondomesticatari-view"
            });
    ...
    Alpaca.registerFieldClass("datiImmobileNonDomesticaTari", Alpaca.Fields.DatiImmobileNonDomesticaTariField); 
    
    Alpaca.registerView({
        "id": "immobilenondomesticatari-view",
        ...
        "templates": {
        	"container": datiImmobileNonDomesticaTariContainer,
        	"container-object": datiImmobileNonDomesticaTariContainerObject
        }
    });

    Alpaca.registerMessages({
        "addItemButtonLabel": "Aggiungi Immobile"
    }, "immobilenondomesticatari-view");
