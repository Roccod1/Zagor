...
package it.servizidigitali.scrivaniacittadino.service.persistence;
...
public class FooUtil {
	...
	public static Foo findByUuid_First(
		...
		throws it.servizidigitali.scrivaniacittadino.exception.
			NoSuchFooException {
