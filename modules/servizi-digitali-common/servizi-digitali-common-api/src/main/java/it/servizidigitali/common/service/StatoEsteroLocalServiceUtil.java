...
/**
 * Provides the local service utility for StatoEstero. This utility wraps
 * <code>it.servizidigitali.common.service.impl.StatoEsteroLocalServiceImpl</code> and
 ...
 * @generated
 */
public class StatoEsteroLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.servizidigitali.common.service.impl.StatoEsteroLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static StatoEstero addStatoEstero(StatoEstero statoEstero) {
		return getService().addStatoEstero(statoEstero);
	}
	 ...
	 */
	public static StatoEstero createStatoEstero(long statoEsteroId) {
		return getService().createStatoEstero(statoEsteroId);
	}
	 ...
	 */
	public static StatoEstero deleteStatoEstero(long statoEsteroId)
		throws PortalException {

		return getService().deleteStatoEstero(statoEsteroId);
	}
	 ...
	 * @return the stato estero that was removed
	 */
	public static StatoEstero deleteStatoEstero(StatoEstero statoEstero) {
		return getService().deleteStatoEstero(statoEstero);
	}
	...
	public static StatoEstero fetchStatoEstero(long statoEsteroId) {
		return getService().fetchStatoEstero(statoEsteroId);
	}
	 ...
	 * @throws PortalException if a stato estero with the primary key could not be found
	 */
	public static StatoEstero getStatoEstero(long statoEsteroId)
		throws PortalException {
	...
	public static StatoEstero getStatoEsteroByDenominazione(
		...
		return getService().getStatoEsteroByDenominazione(denominazione);
	}
	 ...
	 */
	public static List<StatoEstero> getStatoEsteros(int start, int end) {
		return getService().getStatoEsteros(start, end);
	}
	 ...
	 */
	public static int getStatoEsterosCount() {
		return getService().getStatoEsterosCount();
	}
	 ...
	 */
	public static StatoEstero updateStatoEstero(StatoEstero statoEstero) {
		return getService().updateStatoEstero(statoEstero);
	}

	public static StatoEsteroLocalService getService() {
		return _service;
	}

	private static volatile StatoEsteroLocalService _service;
