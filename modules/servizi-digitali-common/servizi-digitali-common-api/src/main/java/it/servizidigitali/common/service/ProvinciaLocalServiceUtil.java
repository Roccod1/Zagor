 ...
 * <code>it.servizidigitali.common.service.impl.ProvinciaLocalServiceImpl</code> and
...
public class ProvinciaLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.servizidigitali.common.service.impl.ProvinciaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Provincia addProvincia(Provincia provincia) {
	 ...
	 */
	public static Provincia createProvincia(long provinciaId) {
		return getService().createProvincia(provinciaId);
	}
	 ...
	 */
	public static Provincia deleteProvincia(long provinciaId)
		throws PortalException {

		return getService().deleteProvincia(provinciaId);
	}
	 ...
	 * @return the provincia that was removed
	 */
	public static Provincia deleteProvincia(Provincia provincia) {
	...
	public static Provincia fetchProvincia(long provinciaId) {
		return getService().fetchProvincia(provinciaId);
	}
	 ...
	 * @throws PortalException if a provincia with the primary key could not be found
	 */
	public static Provincia getProvincia(long provinciaId)
		throws PortalException {
	 ...
	 */
	public static List<Provincia> getProvincias(int start, int end) {
	 ...
	 */
	public static Provincia updateProvincia(Provincia provincia) {
	...
	private static volatile ProvinciaLocalService _service;
