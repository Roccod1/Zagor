...
/**
 * Provides the local service interface for Provincia. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProvinciaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProvinciaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.servizidigitali.common.service.impl.ProvinciaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the provincia local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProvinciaLocalServiceUtil} if injection and service tracking are not available.
	 */
