...
/**
 * Provides the local service interface for StatoEstero. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StatoEsteroLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StatoEsteroLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.servizidigitali.common.service.impl.StatoEsteroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the stato estero local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StatoEsteroLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public StatoEstero addStatoEstero(StatoEstero statoEstero);
	...
	public StatoEstero createStatoEstero(long statoEsteroId);
	...
	public StatoEstero deleteStatoEstero(long statoEsteroId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public StatoEstero deleteStatoEstero(StatoEstero statoEstero);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StatoEstero fetchStatoEstero(long statoEsteroId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StatoEstero getStatoEstero(long statoEsteroId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StatoEstero> getStatoEsteros(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public StatoEstero updateStatoEstero(StatoEstero statoEstero);
