 ...
 * <code>it.servizidigitali.gestioneforms.service.impl.FormLocalServiceImpl</code> and
...
public class FormLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.servizidigitali.gestioneforms.service.impl.FormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static List<Form> getFormsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getFormsByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Form> getFormsByUuidAndCompanyId(
		...
		return getService().getFormsByUuidAndCompanyId(
