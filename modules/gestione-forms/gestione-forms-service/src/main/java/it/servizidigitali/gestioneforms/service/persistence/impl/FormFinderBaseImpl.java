 ...
 * @generated
 */
public abstract class FormFinderBaseImpl extends BasePersistenceImpl<Form> {

	public FormFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return formPersistence.getBadColumnNames();
	}
