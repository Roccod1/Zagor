...
import it.servizidigitali.gestioneforms.service.TipoDocumentoLocalServiceUtil;
...
/**
 * Provides the base implementation for the tipo documento local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.servizidigitali.gestioneforms.service.impl.TipoDocumentoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see it.servizidigitali.gestioneforms.service.impl.TipoDocumentoLocalServiceImpl
 * @generated
 */
public abstract class TipoDocumentoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TipoDocumentoLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TipoDocumentoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TipoDocumentoLocalServiceUtil</code>.
	 */
	...
	public TipoDocumento addTipoDocumento(TipoDocumento tipoDocumento) {
		...
		return tipoDocumentoPersistence.update(tipoDocumento);
	}
	...
	public TipoDocumento createTipoDocumento(long tipoDocumentoId) {
		return tipoDocumentoPersistence.create(tipoDocumentoId);
	}
	...
	public TipoDocumento deleteTipoDocumento(long tipoDocumentoId)
		...
		return tipoDocumentoPersistence.remove(tipoDocumentoId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return tipoDocumentoPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TipoDocumento.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return tipoDocumentoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return tipoDocumentoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TipoDocumento fetchTipoDocumento(long tipoDocumentoId) {
		return tipoDocumentoPersistence.fetchByPrimaryKey(tipoDocumentoId);
	}
	...
	public TipoDocumento fetchTipoDocumentoByUuidAndGroupId(
		...
		return tipoDocumentoPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public TipoDocumento getTipoDocumento(long tipoDocumentoId)
		...
		return tipoDocumentoPersistence.findByPrimaryKey(tipoDocumentoId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(tipoDocumentoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TipoDocumento.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("tipoDocumentoId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TipoDocumento.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<TipoDocumento>() {

				@Override
				public void performAction(TipoDocumento tipoDocumento)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, tipoDocumento);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return tipoDocumentoPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return tipoDocumentoLocalService.deleteTipoDocumento(
			(TipoDocumento)persistedModel);
	}

	@Override
	public BasePersistence<TipoDocumento> getBasePersistence() {
	...
	public List<TipoDocumento> getTipoDocumentosByUuidAndCompanyId(
		...
		return tipoDocumentoPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<TipoDocumento> getTipoDocumentosByUuidAndCompanyId(
		...
		return tipoDocumentoPersistence.findByUuid_C(
	...
	public TipoDocumento getTipoDocumentoByUuidAndGroupId(
		...
		return tipoDocumentoPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TipoDocumentoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		tipoDocumentoLocalService = (TipoDocumentoLocalService)aopProxy;

		_setLocalServiceUtilService(tipoDocumentoLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TipoDocumentoLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TipoDocumentoLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, tipoDocumentoLocalService);
		}
