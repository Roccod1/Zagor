 ...
 * @generated
 */
public abstract class ServizioFinderBaseImpl
	extends BasePersistenceImpl<Servizio> {

	public ServizioFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return servizioPersistence.getBadColumnNames();
	}
