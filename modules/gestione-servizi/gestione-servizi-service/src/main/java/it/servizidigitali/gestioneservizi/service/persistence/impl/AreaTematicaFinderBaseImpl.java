 ...
 * @generated
 */
public abstract class AreaTematicaFinderBaseImpl
	extends BasePersistenceImpl<AreaTematica> {

	public AreaTematicaFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return areaTematicaPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AreaTematicaFinderBaseImpl.class);
