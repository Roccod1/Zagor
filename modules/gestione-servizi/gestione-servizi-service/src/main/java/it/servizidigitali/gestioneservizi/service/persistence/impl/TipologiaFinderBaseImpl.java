 ...
 * @generated
 */
public abstract class TipologiaFinderBaseImpl
	extends BasePersistenceImpl<Tipologia> {

	public TipologiaFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return tipologiaPersistence.getBadColumnNames();
	}
