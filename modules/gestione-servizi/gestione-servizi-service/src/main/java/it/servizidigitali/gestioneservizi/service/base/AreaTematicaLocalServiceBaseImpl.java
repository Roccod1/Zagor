...
/**
 * Provides the base implementation for the area tematica local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.servizidigitali.gestioneservizi.service.impl.AreaTematicaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see it.servizidigitali.gestioneservizi.service.impl.AreaTematicaLocalServiceImpl
 * @generated
 */
public abstract class AreaTematicaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, AreaTematicaLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AreaTematicaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AreaTematicaLocalServiceUtil</code>.
	 */
	...
	public AreaTematica addAreaTematica(AreaTematica areaTematica) {
		...
		return areaTematicaPersistence.update(areaTematica);
	}
	...
	public AreaTematica createAreaTematica(long areaTematicaId) {
		return areaTematicaPersistence.create(areaTematicaId);
	}
	...
	public AreaTematica deleteAreaTematica(long areaTematicaId)
		...
		return areaTematicaPersistence.remove(areaTematicaId);
	}
	...
	public AreaTematica deleteAreaTematica(AreaTematica areaTematica) {
		return areaTematicaPersistence.remove(areaTematica);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return areaTematicaPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AreaTematica.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return areaTematicaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return areaTematicaPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return areaTematicaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return areaTematicaPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AreaTematica fetchAreaTematica(long areaTematicaId) {
		return areaTematicaPersistence.fetchByPrimaryKey(areaTematicaId);
	}
	...
	public AreaTematica fetchAreaTematicaByUuidAndGroupId(
		...
		return areaTematicaPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public AreaTematica getAreaTematica(long areaTematicaId)
		...
		return areaTematicaPersistence.findByPrimaryKey(areaTematicaId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(areaTematicaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AreaTematica.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("areaTematicaId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			areaTematicaLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AreaTematica.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<AreaTematica>() {

				@Override
				public void performAction(AreaTematica areaTematica)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, areaTematica);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return areaTematicaPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return areaTematicaLocalService.deleteAreaTematica(
			(AreaTematica)persistedModel);
	}

	@Override
	public BasePersistence<AreaTematica> getBasePersistence() {
		return areaTematicaPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return areaTematicaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AreaTematica> getAreaTematicasByUuidAndCompanyId(
		...
		return areaTematicaPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<AreaTematica> getAreaTematicasByUuidAndCompanyId(
		...
		return areaTematicaPersistence.findByUuid_C(
	...
	public AreaTematica getAreaTematicaByUuidAndGroupId(
		...
		return areaTematicaPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<AreaTematica> getAreaTematicas(int start, int end) {
		return areaTematicaPersistence.findAll(start, end);
	}
	...
	public int getAreaTematicasCount() {
		return areaTematicaPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AreaTematicaLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		areaTematicaLocalService = (AreaTematicaLocalService)aopProxy;

		_setLocalServiceUtilService(areaTematicaLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AreaTematicaLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = areaTematicaPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = AreaTematicaLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, areaTematicaLocalService);
		}
	...
	protected AreaTematicaLocalService areaTematicaLocalService;
