...
@Component(
	name="gestioneEntiMiddlewareService",
	immediate = true,
	service = GestioneEntiMiddlewareService.class
)
...
//	ritorna le pagine che e' possibile utilizzare per URI pubblica o URI guest
	public Map<String, List<Layout>> getListaPagineUtilizzabili(long groupId, long organizationId, long servizioId, long companyId) throws Exception{
...
//			ottengo tutte le pagine dei servizi
	...
	public List<JournalArticle> getListaArticleIdDisponibili(long groupId, long organizationId, long servizioId){
