...
public class GestioneEntiPortletKeys {
	...
	public static final String SOTTO_ORGANIZZAZIONI = "sottoOrganizzazioni";
	...
	public static final String SERVIZIO_SOTTO_ORGANIZZAZIONE_ID = "subOrganizationId";
	...
	public static final String STRUCTURE_NAME_SCHEDA_SERVIZIO = "Scheda servizio";
