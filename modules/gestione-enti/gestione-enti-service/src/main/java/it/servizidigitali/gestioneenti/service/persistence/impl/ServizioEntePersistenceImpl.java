...
public class ServizioEntePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByOrganizationIdAttivo;
	private FinderPath _finderPathWithoutPaginationFindByOrganizationIdAttivo;
	private FinderPath _finderPathCountByOrganizationIdAttivo;
	 ...
	 */
	@Override
	public List<ServizioEnte> findByOrganizationIdAttivo(
		long organizationId, boolean attivo) {

		return findByOrganizationIdAttivo(
			organizationId, attivo, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<ServizioEnte> findByOrganizationIdAttivo(
		...
		return findByOrganizationIdAttivo(
			organizationId, attivo, start, end, null);
	}
	...
	public List<ServizioEnte> findByOrganizationIdAttivo(
		...
		return findByOrganizationIdAttivo(
			organizationId, attivo, start, end, orderByComparator, true);
	}
	...
	public List<ServizioEnte> findByOrganizationIdAttivo(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByOrganizationIdAttivo;
				finderArgs = new Object[] {organizationId, attivo};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByOrganizationIdAttivo;
			finderArgs = new Object[] {
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_ORGANIZATIONIDATTIVO_ORGANIZATIONID_2);

			sb.append(_FINDER_COLUMN_ORGANIZATIONIDATTIVO_ATTIVO_2);
	 ...
	 */
	@Override
	public ServizioEnte findByOrganizationIdAttivo_First(
			long organizationId, boolean attivo,
			OrderByComparator<ServizioEnte> orderByComparator)
		throws NoSuchServizioEnteException {

		ServizioEnte servizioEnte = fetchByOrganizationIdAttivo_First(
	 ...
	 */
	@Override
	public ServizioEnte fetchByOrganizationIdAttivo_First(
		long organizationId, boolean attivo,
		OrderByComparator<ServizioEnte> orderByComparator) {

		List<ServizioEnte> list = findByOrganizationIdAttivo(
			organizationId, attivo, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ServizioEnte findByOrganizationIdAttivo_Last(
			long organizationId, boolean attivo,
			OrderByComparator<ServizioEnte> orderByComparator)
		throws NoSuchServizioEnteException {

		ServizioEnte servizioEnte = fetchByOrganizationIdAttivo_Last(
			organizationId, attivo, orderByComparator);
	 ...
	 */
	@Override
	public ServizioEnte fetchByOrganizationIdAttivo_Last(
		long organizationId, boolean attivo,
		OrderByComparator<ServizioEnte> orderByComparator) {

		int count = countByOrganizationIdAttivo(organizationId, attivo);
		...
		List<ServizioEnte> list = findByOrganizationIdAttivo(
			organizationId, attivo, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public ServizioEnte[] findByOrganizationIdAttivo_PrevAndNext(
			ServizioEntePK servizioEntePK, long organizationId, boolean attivo,
			OrderByComparator<ServizioEnte> orderByComparator)
		throws NoSuchServizioEnteException {
		...
		try {
			...
			array[0] = getByOrganizationIdAttivo_PrevAndNext(
				session, servizioEnte, organizationId, attivo,
				orderByComparator, true);

			array[1] = servizioEnte;

			array[2] = getByOrganizationIdAttivo_PrevAndNext(
				session, servizioEnte, organizationId, attivo,
	...
	protected ServizioEnte getByOrganizationIdAttivo_PrevAndNext(
		Session session, ServizioEnte servizioEnte, long organizationId,
		boolean attivo, OrderByComparator<ServizioEnte> orderByComparator,
		boolean previous) {
	 ...
	 */
	@Override
	public void removeByOrganizationIdAttivo(
		long organizationId, boolean attivo) {

		for (ServizioEnte servizioEnte :
				findByOrganizationIdAttivo(
					organizationId, attivo, QueryUtil.ALL_POS,
	 ...
	 */
	@Override
	public int countByOrganizationIdAttivo(
		long organizationId, boolean attivo) {

		FinderPath finderPath = _finderPathCountByOrganizationIdAttivo;

		Object[] finderArgs = new Object[] {organizationId, attivo};
	...
	private static final String
		_FINDER_COLUMN_ORGANIZATIONIDATTIVO_ORGANIZATIONID_2 =
			"servizioEnte.id.organizationId = ? AND ";

	private static final String _FINDER_COLUMN_ORGANIZATIONIDATTIVO_ATTIVO_2 =
		"servizioEnte.attivo = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByOrganizationIdAttivo = new FinderPath(
			...
			new String[] {"organizationId", "attivo"}, true);

		_finderPathWithoutPaginationFindByOrganizationIdAttivo = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByOrganizationIdAttivo",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"organizationId", "attivo"}, true);

		_finderPathCountByOrganizationIdAttivo = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByOrganizationIdAttivo",
			new String[] {Long.class.getName(), Boolean.class.getName()},
			new String[] {"organizationId", "attivo"}, false);
