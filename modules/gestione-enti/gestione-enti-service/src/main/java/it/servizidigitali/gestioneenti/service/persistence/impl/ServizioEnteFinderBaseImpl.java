 ...
 * @generated
 */
public abstract class ServizioEnteFinderBaseImpl
	extends BasePersistenceImpl<ServizioEnte> {

	public ServizioEnteFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return servizioEntePersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ServizioEnteFinderBaseImpl.class);
