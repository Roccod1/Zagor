 ...
 * @generated
 */
public abstract class PagamentoFinderBaseImpl
	extends BasePersistenceImpl<Pagamento> {

	public PagamentoFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return pagamentoPersistence.getBadColumnNames();
	}
