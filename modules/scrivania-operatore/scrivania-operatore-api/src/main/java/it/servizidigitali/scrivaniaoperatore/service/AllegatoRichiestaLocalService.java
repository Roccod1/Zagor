...
/**
 * Provides the local service interface for AllegatoRichiesta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AllegatoRichiestaLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AllegatoRichiestaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.servizidigitali.scrivaniaoperatore.service.impl.AllegatoRichiestaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the allegato richiesta local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AllegatoRichiestaLocalServiceUtil} if injection and service tracking are not available.
	 */
