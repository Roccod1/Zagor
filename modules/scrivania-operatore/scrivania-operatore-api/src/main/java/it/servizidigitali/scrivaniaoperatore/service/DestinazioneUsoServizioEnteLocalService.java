...
/**
 * Provides the local service interface for DestinazioneUsoServizioEnte. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DestinazioneUsoServizioEnteLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DestinazioneUsoServizioEnteLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.servizidigitali.scrivaniaoperatore.service.impl.DestinazioneUsoServizioEnteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the destinazione uso servizio ente local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DestinazioneUsoServizioEnteLocalServiceUtil} if injection and service tracking are not available.
	 */
