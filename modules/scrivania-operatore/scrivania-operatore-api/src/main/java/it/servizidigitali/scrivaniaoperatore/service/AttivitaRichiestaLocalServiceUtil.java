...
/**
 * Provides the local service utility for AttivitaRichiesta. This utility wraps
 * <code>it.servizidigitali.scrivaniaoperatore.service.impl.AttivitaRichiestaLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AttivitaRichiestaLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.servizidigitali.scrivaniaoperatore.service.impl.AttivitaRichiestaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AttivitaRichiesta addAttivitaRichiesta(
	 ...
	 */
	public static AttivitaRichiesta createAttivitaRichiesta(
		long attivitaRichiestaId) {

		return getService().createAttivitaRichiesta(attivitaRichiestaId);
	}
	 ...
	 */
	public static AttivitaRichiesta deleteAttivitaRichiesta(
		AttivitaRichiesta attivitaRichiesta) {

		return getService().deleteAttivitaRichiesta(attivitaRichiesta);
	}
	...
	public static AttivitaRichiesta deleteAttivitaRichiesta(
		...
		return getService().deleteAttivitaRichiesta(attivitaRichiestaId);
	}
	...
	public static AttivitaRichiesta fetchAttivitaRichiesta(
		long attivitaRichiestaId) {

		return getService().fetchAttivitaRichiesta(attivitaRichiestaId);
	}
	 ...
	 */
	public static AttivitaRichiesta fetchAttivitaRichiestaByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchAttivitaRichiestaByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a attivita richiesta with the primary key could not be found
	 */
	public static AttivitaRichiesta getAttivitaRichiesta(
			long attivitaRichiestaId)
		throws PortalException {

		return getService().getAttivitaRichiesta(attivitaRichiestaId);
	}
	 ...
	 */
	public static AttivitaRichiesta getAttivitaRichiestaByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getAttivitaRichiestaByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<AttivitaRichiesta> getAttivitaRichiestas(
		int start, int end) {

		return getService().getAttivitaRichiestas(start, end);
	}
	 ...
	 */
	public static List<AttivitaRichiesta>
		getAttivitaRichiestasByUuidAndCompanyId(String uuid, long companyId) {

		return getService().getAttivitaRichiestasByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getAttivitaRichiestasCount() {
		return getService().getAttivitaRichiestasCount();
	}
	 ...
	 */
	public static AttivitaRichiesta updateAttivitaRichiesta(
		AttivitaRichiesta attivitaRichiesta) {

		return getService().updateAttivitaRichiesta(attivitaRichiesta);
	}

	public static AttivitaRichiestaLocalService getService() {
		return _service;
	}

	private static volatile AttivitaRichiestaLocalService _service;
