...
@Component(immediate = true, service = MVCActionCommand.class, property = {
		...
		"mvc.command.name=/action/chiudiEsitoPositivo"
})
public class ChiudiEsitoPositivoActionCommand extends BaseMVCActionCommand {
	...
	private static final Log _log = LogFactoryUtil.getLog(ChiudiEsitoPositivoActionCommand.class);
}
