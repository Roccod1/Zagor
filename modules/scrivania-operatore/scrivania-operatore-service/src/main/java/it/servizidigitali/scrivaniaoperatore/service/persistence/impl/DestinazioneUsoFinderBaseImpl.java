 ...
 * @generated
 */
public abstract class DestinazioneUsoFinderBaseImpl
	extends BasePersistenceImpl<DestinazioneUso> {

	public DestinazioneUsoFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return destinazioneUsoPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DestinazioneUsoFinderBaseImpl.class);
