 ...
 * @generated
 */
public abstract class RichiestaFinderBaseImpl
	extends BasePersistenceImpl<Richiesta> {

	public RichiestaFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return richiestaPersistence.getBadColumnNames();
	}
