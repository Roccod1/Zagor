...
/**
 * The persistence utility for the tipologia comunicazione service. This utility wraps <code>it.servizidigitali.gestionecomunicazioni.service.persistence.impl.TipologiaComunicazionePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TipologiaComunicazionePersistence
 * @generated
 */
public class TipologiaComunicazioneUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(tipologiaComunicazione);
	}
	 ...
	 */
	public static Map<Serializable, TipologiaComunicazione> fetchByPrimaryKeys(
	 ...
	 */
	public static List<TipologiaComunicazione> findWithDynamicQuery(
	 ...
	 */
	public static TipologiaComunicazione update(
		TipologiaComunicazione tipologiaComunicazione) {

		return getPersistence().update(tipologiaComunicazione);
	}
	...
	public static TipologiaComunicazione update(
		...
		return getPersistence().update(tipologiaComunicazione, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(tipologiaComunicazione);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(tipologiaComunicaziones);
	}
	 ...
	 */
	public static TipologiaComunicazione create(long tipologiaComunicazioneId) {
		return getPersistence().create(tipologiaComunicazioneId);
	}
	 ...
	 */
	public static TipologiaComunicazione remove(long tipologiaComunicazioneId)
		throws it.servizidigitali.gestionecomunicazioni.exception.
			NoSuchTipologiaComunicazioneException {

		return getPersistence().remove(tipologiaComunicazioneId);
	}

	public static TipologiaComunicazione updateImpl(
		TipologiaComunicazione tipologiaComunicazione) {

		return getPersistence().updateImpl(tipologiaComunicazione);
	}
	 ...
	 * @throws NoSuchTipologiaComunicazioneException if a tipologia comunicazione with the primary key could not be found
	 */
	public static TipologiaComunicazione findByPrimaryKey(
			long tipologiaComunicazioneId)
		throws it.servizidigitali.gestionecomunicazioni.exception.
			NoSuchTipologiaComunicazioneException {

		return getPersistence().findByPrimaryKey(tipologiaComunicazioneId);
	}
	 ...
	 */
	public static TipologiaComunicazione fetchByPrimaryKey(
		long tipologiaComunicazioneId) {

		return getPersistence().fetchByPrimaryKey(tipologiaComunicazioneId);
	}
	 ...
	 */
	public static List<TipologiaComunicazione> findAll() {
	 ...
	 */
	public static List<TipologiaComunicazione> findAll(int start, int end) {
	...
	public static TipologiaComunicazionePersistence getPersistence() {
		return _persistence;
	}

	private static volatile TipologiaComunicazionePersistence _persistence;
