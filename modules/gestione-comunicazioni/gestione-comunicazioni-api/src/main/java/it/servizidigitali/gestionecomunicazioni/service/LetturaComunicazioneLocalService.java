...
/**
 * Provides the local service interface for LetturaComunicazione. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LetturaComunicazioneLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LetturaComunicazioneLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>it.servizidigitali.gestionecomunicazioni.service.impl.LetturaComunicazioneLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the lettura comunicazione local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LetturaComunicazioneLocalServiceUtil} if injection and service tracking are not available.
	 */
