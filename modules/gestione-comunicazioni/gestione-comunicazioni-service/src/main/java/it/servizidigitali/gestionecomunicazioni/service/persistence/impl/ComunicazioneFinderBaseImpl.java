 ...
 * @generated
 */
public abstract class ComunicazioneFinderBaseImpl
	extends BasePersistenceImpl<Comunicazione> {

	public ComunicazioneFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return comunicazionePersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ComunicazioneFinderBaseImpl.class);
