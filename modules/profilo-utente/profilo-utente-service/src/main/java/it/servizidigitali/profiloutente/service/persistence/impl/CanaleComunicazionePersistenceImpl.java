...
public class CanaleComunicazionePersistenceImpl
	 ...
	 */
	@Override
	public List<CanaleComunicazione> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<CanaleComunicazione> findByUuid(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (CanaleComunicazione canaleComunicazione : list) {
					if (!uuid.equals(canaleComunicazione.getUuid())) {
						list = null;
	...
	public CanaleComunicazione findByUuid_First(
		...
		CanaleComunicazione canaleComunicazione = fetchByUuid_First(
	...
	public CanaleComunicazione fetchByUuid_First(
		String uuid, OrderByComparator<CanaleComunicazione> orderByComparator) {

		List<CanaleComunicazione> list = findByUuid(
	...
	public CanaleComunicazione findByUuid_Last(
		...
		CanaleComunicazione canaleComunicazione = fetchByUuid_Last(
			uuid, orderByComparator);
	...
	public CanaleComunicazione[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, canaleComunicazione, uuid, orderByComparator, true);

			array[1] = canaleComunicazione;

			array[2] = getByUuid_PrevAndNext(
				session, canaleComunicazione, uuid, orderByComparator, false);
	...
	protected CanaleComunicazione getByUuid_PrevAndNext(
		Session session, CanaleComunicazione canaleComunicazione, String uuid,
		OrderByComparator<CanaleComunicazione> orderByComparator,
		boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 =
		"canaleComunicazione.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(canaleComunicazione.uuid IS NULL OR canaleComunicazione.uuid = '')";
	...
	public CanaleComunicazione findByUUID_G(String uuid, long groupId)
		...
		CanaleComunicazione canaleComunicazione = fetchByUUID_G(uuid, groupId);
	...
	public CanaleComunicazione fetchByUUID_G(
		...
		if (result instanceof CanaleComunicazione) {
			...
			if (!Objects.equals(uuid, canaleComunicazione.getUuid()) ||
	...
	public CanaleComunicazione removeByUUID_G(String uuid, long groupId)
		...
		CanaleComunicazione canaleComunicazione = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"canaleComunicazione.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(canaleComunicazione.uuid IS NULL OR canaleComunicazione.uuid = '') AND ";

	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 =
		"canaleComunicazione.groupId = ?";
	 ...
	 */
	@Override
	public List<CanaleComunicazione> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<CanaleComunicazione> findByUuid_C(
	...
	public CanaleComunicazione findByUuid_C_First(
		...
		CanaleComunicazione canaleComunicazione = fetchByUuid_C_First(
	...
	public CanaleComunicazione fetchByUuid_C_First(
		...
		List<CanaleComunicazione> list = findByUuid_C(
	...
	public CanaleComunicazione findByUuid_C_Last(
		...
		CanaleComunicazione canaleComunicazione = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public CanaleComunicazione[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, canaleComunicazione, uuid, companyId,
	...
	protected CanaleComunicazione getByUuid_C_PrevAndNext(
		Session session, CanaleComunicazione canaleComunicazione, String uuid,
		long companyId,
		OrderByComparator<CanaleComunicazione> orderByComparator,
		boolean previous) {
	...
	public void cacheResult(CanaleComunicazione canaleComunicazione) {
		...
		finderCache.putResult(
			...
			new Object[] {
				canaleComunicazione.getUuid(), canaleComunicazione.getGroupId()
			},
			canaleComunicazione);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			canaleComunicazioneModelImpl.getUuid(),
			canaleComunicazioneModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, canaleComunicazioneModelImpl);

		args = new Object[] {canaleComunicazioneModelImpl.getCodice()};
	...
	public CanaleComunicazione create(long canaleComunicazioneId) {
		...
		canaleComunicazione.setUuid(uuid);
	...
	public CanaleComunicazione updateImpl(
		...
		if (Validator.isNull(canaleComunicazione.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (canaleComunicazione.getCreateDate() == null)) {
			if (serviceContext == null) {
				canaleComunicazione.setCreateDate(date);
			}
			else {
		...
		if (!canaleComunicazioneModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				canaleComunicazione.setModifiedDate(date);
			}
			else {
