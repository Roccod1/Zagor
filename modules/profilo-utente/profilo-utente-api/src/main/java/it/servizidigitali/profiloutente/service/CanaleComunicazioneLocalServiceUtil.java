...
/**
 * Provides the local service utility for CanaleComunicazione. This utility wraps
 * <code>it.servizidigitali.profiloutente.service.impl.CanaleComunicazioneLocalServiceImpl</code> and
 ...
 * @generated
 */
public class CanaleComunicazioneLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>it.servizidigitali.profiloutente.service.impl.CanaleComunicazioneLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static CanaleComunicazione addCanaleComunicazione(
		CanaleComunicazione canaleComunicazione) {

		return getService().addCanaleComunicazione(canaleComunicazione);
	}
	 ...
	 */
	public static CanaleComunicazione createCanaleComunicazione(
		long canaleComunicazioneId) {

		return getService().createCanaleComunicazione(canaleComunicazioneId);
	}
	 ...
	 */
	public static CanaleComunicazione deleteCanaleComunicazione(
		CanaleComunicazione canaleComunicazione) {

		return getService().deleteCanaleComunicazione(canaleComunicazione);
	}
	...
	public static CanaleComunicazione deleteCanaleComunicazione(
		...
		return getService().deleteCanaleComunicazione(canaleComunicazioneId);
	}
	...
	public static CanaleComunicazione fetchCanaleComunicazione(
		long canaleComunicazioneId) {
	 ...
	 * @throws PortalException if a canale comunicazione with the primary key could not be found
	 */
	public static CanaleComunicazione getCanaleComunicazione(
			long canaleComunicazioneId)
		throws PortalException {

		return getService().getCanaleComunicazione(canaleComunicazioneId);
	}
	 ...
	 */
	public static List<CanaleComunicazione> getCanaleComunicaziones(
		int start, int end) {
	 ...
	 */
	public static CanaleComunicazione updateCanaleComunicazione(
		CanaleComunicazione canaleComunicazione) {

		return getService().updateCanaleComunicazione(canaleComunicazione);
	}

	public static CanaleComunicazioneLocalService getService() {
		return _service;
	}

	private static volatile CanaleComunicazioneLocalService _service;
