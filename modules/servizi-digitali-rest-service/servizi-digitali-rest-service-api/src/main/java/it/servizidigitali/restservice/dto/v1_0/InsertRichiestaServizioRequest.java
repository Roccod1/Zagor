 ...
 */
@Generated("")
@GraphQLName("InsertRichiestaServizioRequest")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "InsertRichiestaServizioRequest")
public class InsertRichiestaServizioRequest implements Serializable {

	public static InsertRichiestaServizioRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(
			InsertRichiestaServizioRequest.class, json);
	}

	public static InsertRichiestaServizioRequest unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "it.servizidigitali.restservice.dto.v1_0.InsertRichiestaServizioRequest",
		name = "x-class-name"
	)
