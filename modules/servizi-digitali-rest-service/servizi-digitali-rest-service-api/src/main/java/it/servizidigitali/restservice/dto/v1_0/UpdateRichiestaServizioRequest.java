 ...
 */
@Generated("")
@GraphQLName("UpdateRichiestaServizioRequest")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UpdateRichiestaServizioRequest")
public class UpdateRichiestaServizioRequest implements Serializable {

	public static UpdateRichiestaServizioRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(
			UpdateRichiestaServizioRequest.class, json);
	}

	public static UpdateRichiestaServizioRequest unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "it.servizidigitali.restservice.dto.v1_0.UpdateRichiestaServizioRequest",
		name = "x-class-name"
	)
