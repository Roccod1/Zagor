 ...
 */
@Generated("")
@GraphQLName("UpdateStatoRichiestaServizioRequest")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UpdateStatoRichiestaServizioRequest")
public class UpdateStatoRichiestaServizioRequest implements Serializable {

	public static UpdateStatoRichiestaServizioRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(
			UpdateStatoRichiestaServizioRequest.class, json);
	}

	public static UpdateStatoRichiestaServizioRequest unsafeToDTO(String json) {
	...
	@Schema(
		...
		defaultValue = "it.servizidigitali.restservice.dto.v1_0.UpdateStatoRichiestaServizioRequest",
		name = "x-class-name"
	)
