...
public class ProcessoPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByMultiente;
	private FinderPath _finderPathWithoutPaginationFindByMultiente;
	private FinderPath _finderPathCountByMultiente;

	/**
	 * Returns all the processos where multiente = &#63;.
	 *
	 * @param multiente the multiente
	 * @return the matching processos
	 */
	@Override
	public List<Processo> findByMultiente(boolean multiente) {
		return findByMultiente(
			multiente, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the processos where multiente = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ProcessoModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<Processo> findByMultiente(
		boolean multiente, int start, int end) {

		return findByMultiente(multiente, start, end, null);
	}

	/**
	 * Returns an ordered range of all the processos where multiente = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>ProcessoModelImpl</code>.
	 * </p>
	...
	public List<Processo> findByMultiente(
		...
		return findByMultiente(multiente, start, end, orderByComparator, true);
	}
	...
	public List<Processo> findByMultiente(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByMultiente;
				finderArgs = new Object[] {multiente};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByMultiente;
			finderArgs = new Object[] {
				multiente, start, end, orderByComparator
			};
		}
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Processo processo : list) {
					if (multiente != processo.isMultiente()) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_MULTIENTE_MULTIENTE_2);
	...
	/**
	 * Returns the first processo in the ordered set where multiente = &#63;.
	 *
	 * @param multiente the multiente
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching processo
	 ...
	 */
	@Override
	public Processo findByMultiente_First(
			boolean multiente, OrderByComparator<Processo> orderByComparator)
		throws NoSuchProcessoException {

		Processo processo = fetchByMultiente_First(
			multiente, orderByComparator);
	 ...
	 */
	@Override
	public Processo fetchByMultiente_First(
		boolean multiente, OrderByComparator<Processo> orderByComparator) {

		List<Processo> list = findByMultiente(
			multiente, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last processo in the ordered set where multiente = &#63;.
	 *
	 * @param multiente the multiente
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching processo
	 ...
	 */
	@Override
	public Processo findByMultiente_Last(
			boolean multiente, OrderByComparator<Processo> orderByComparator)
		throws NoSuchProcessoException {

		Processo processo = fetchByMultiente_Last(multiente, orderByComparator);
	 ...
	 */
	@Override
	public Processo fetchByMultiente_Last(
		boolean multiente, OrderByComparator<Processo> orderByComparator) {

		int count = countByMultiente(multiente);
		...
		List<Processo> list = findByMultiente(
			multiente, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the processos before and after the current processo in the ordered set where multiente = &#63;.
	 *
	 * @param processoId the primary key of the current processo
	 * @param multiente the multiente
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Processo[] findByMultiente_PrevAndNext(
			long processoId, boolean multiente,
			OrderByComparator<Processo> orderByComparator)
		throws NoSuchProcessoException {
		...
		try {
			...
			array[0] = getByMultiente_PrevAndNext(
				session, processo, multiente, orderByComparator, true);

			array[1] = processo;

			array[2] = getByMultiente_PrevAndNext(
				session, processo, multiente, orderByComparator, false);
	...
	protected Processo getByMultiente_PrevAndNext(
		Session session, Processo processo, boolean multiente,
		OrderByComparator<Processo> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the processos where multiente = &#63; from the database.
	 *
	 * @param multiente the multiente
	 */
	@Override
	public void removeByMultiente(boolean multiente) {
		for (Processo processo :
				findByMultiente(
					multiente, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of processos where multiente = &#63;.
	 *
	 * @param multiente the multiente
	 * @return the number of matching processos
	 */
	@Override
	public int countByMultiente(boolean multiente) {
		FinderPath finderPath = _finderPathCountByMultiente;

		Object[] finderArgs = new Object[] {multiente};
	...
	private static final String _FINDER_COLUMN_MULTIENTE_MULTIENTE_2 =
		"processo.multiente = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByMultiente = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByMultiente",
			new String[] {
				Boolean.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"multiente"}, true);

		_finderPathWithoutPaginationFindByMultiente = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByMultiente",
			new String[] {Boolean.class.getName()}, new String[] {"multiente"},
			true);

		_finderPathCountByMultiente = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByMultiente",
			new String[] {Boolean.class.getName()}, new String[] {"multiente"},
			false);
