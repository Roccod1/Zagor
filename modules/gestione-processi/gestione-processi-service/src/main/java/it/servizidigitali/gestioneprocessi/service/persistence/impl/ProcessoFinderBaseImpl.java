 ...
 * @generated
 */
public abstract class ProcessoFinderBaseImpl
	extends BasePersistenceImpl<Processo> {

	public ProcessoFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return processoPersistence.getBadColumnNames();
	}
