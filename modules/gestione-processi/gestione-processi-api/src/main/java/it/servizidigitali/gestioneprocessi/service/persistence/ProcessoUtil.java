...
public class ProcessoUtil {
	 ...
	 * @return the matching processos
	 */
	public static List<Processo> findByMultiente(boolean multiente) {
		return getPersistence().findByMultiente(multiente);
	}
	 ...
	 * @return the range of matching processos
	 */
	public static List<Processo> findByMultiente(
		boolean multiente, int start, int end) {

		return getPersistence().findByMultiente(multiente, start, end);
	}
	...
	public static List<Processo> findByMultiente(
		...
		return getPersistence().findByMultiente(
	...
	public static List<Processo> findByMultiente(
		...
		return getPersistence().findByMultiente(
			multiente, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchProcessoException if a matching processo could not be found
	 */
	public static Processo findByMultiente_First(
			boolean multiente, OrderByComparator<Processo> orderByComparator)
		throws it.servizidigitali.gestioneprocessi.exception.
			NoSuchProcessoException {

		return getPersistence().findByMultiente_First(
	 ...
	 * @return the first matching processo, or <code>null</code> if a matching processo could not be found
	 */
	public static Processo fetchByMultiente_First(
		boolean multiente, OrderByComparator<Processo> orderByComparator) {

		return getPersistence().fetchByMultiente_First(
			multiente, orderByComparator);
	}
	 ...
	 * @throws NoSuchProcessoException if a matching processo could not be found
	 */
	public static Processo findByMultiente_Last(
			boolean multiente, OrderByComparator<Processo> orderByComparator)
		throws it.servizidigitali.gestioneprocessi.exception.
			NoSuchProcessoException {

		return getPersistence().findByMultiente_Last(
			multiente, orderByComparator);
	}
	 ...
	 * @return the last matching processo, or <code>null</code> if a matching processo could not be found
	 */
	public static Processo fetchByMultiente_Last(
		boolean multiente, OrderByComparator<Processo> orderByComparator) {

		return getPersistence().fetchByMultiente_Last(
			multiente, orderByComparator);
	}
	 ...
	 * @throws NoSuchProcessoException if a processo with the primary key could not be found
	 */
	public static Processo[] findByMultiente_PrevAndNext(
			long processoId, boolean multiente,
			OrderByComparator<Processo> orderByComparator)
		throws it.servizidigitali.gestioneprocessi.exception.
			NoSuchProcessoException {

		return getPersistence().findByMultiente_PrevAndNext(
			processoId, multiente, orderByComparator);
	}
	 ...
	 * @param multiente the multiente
	 */
	public static void removeByMultiente(boolean multiente) {
		getPersistence().removeByMultiente(multiente);
	}
	 ...
	 * @return the number of matching processos
	 */
	public static int countByMultiente(boolean multiente) {
		return getPersistence().countByMultiente(multiente);
	}
