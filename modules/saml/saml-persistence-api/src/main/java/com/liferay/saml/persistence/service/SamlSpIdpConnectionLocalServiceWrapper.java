...
public class SamlSpIdpConnectionLocalServiceWrapper
	...
	public com.liferay.saml.persistence.model.SamlSpIdpConnection
			addSamlSpIdpConnection(
				...
				boolean isPassive, boolean addPassiveAuthnRequest,
				boolean requestedAuthnContext, String authnContextClassRef,
		...
		return _samlSpIdpConnectionLocalService.addSamlSpIdpConnection(
			...
			userIdentifierExpression, isPassive, addPassiveAuthnRequest,
			requestedAuthnContext, authnContextClassRef,
			checkMandatoryAuthentication, serviceContext);
	}
