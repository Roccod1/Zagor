 ...
 * @generated
 */
public abstract class RichiestaCertificatoFinderBaseImpl
	extends BasePersistenceImpl<RichiestaCertificato> {

	public RichiestaCertificatoFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return richiestaCertificatoPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RichiestaCertificatoFinderBaseImpl.class);
