...
/**
 * The persistence utility for the responsabile ente service. This utility wraps <code>it.servizidigitali.accreditamentoenti.service.persistence.impl.ResponsabileEntePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ResponsabileEntePersistence
 * @generated
 */
public class ResponsabileEnteUtil {
	 ...
	 */
	public static void clearCache(ResponsabileEnte responsabileEnte) {
		getPersistence().clearCache(responsabileEnte);
	}
	 ...
	 */
	public static Map<Serializable, ResponsabileEnte> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ResponsabileEnte> findWithDynamicQuery(
	 ...
	 */
	public static ResponsabileEnte update(ResponsabileEnte responsabileEnte) {
		return getPersistence().update(responsabileEnte);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static ResponsabileEnte update(
		ResponsabileEnte responsabileEnte, ServiceContext serviceContext) {

		return getPersistence().update(responsabileEnte, serviceContext);
	}
	 ...
	 */
	public static List<ResponsabileEnte> findByUuid(String uuid) {
	 ...
	 */
	public static List<ResponsabileEnte> findByUuid(
	 ...
	 */
	public static ResponsabileEnte findByUuid_First(
	 ...
	 */
	public static ResponsabileEnte fetchByUuid_First(
		String uuid, OrderByComparator<ResponsabileEnte> orderByComparator) {
	 ...
	 * @throws NoSuchResponsabileEnteException if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte findByUuid_Last(
			String uuid, OrderByComparator<ResponsabileEnte> orderByComparator)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {
	 ...
	 */
	public static ResponsabileEnte fetchByUuid_Last(
		String uuid, OrderByComparator<ResponsabileEnte> orderByComparator) {
	 ...
	 */
	public static ResponsabileEnte[] findByUuid_PrevAndNext(
		...
		return getPersistence().findByUuid_PrevAndNext(
			responsabileEnteId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchResponsabileEnteException if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte findByUUID_G(String uuid, long groupId)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {
	 ...
	 */
	public static ResponsabileEnte fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching responsabile ente, or <code>null</code> if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte fetchByUUID_G(
	 ...
	 */
	public static ResponsabileEnte removeByUUID_G(String uuid, long groupId)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {
	 ...
	 * @return the matching responsabile entes
	 */
	public static List<ResponsabileEnte> findByUuid_C(
	 ...
	 * @throws NoSuchResponsabileEnteException if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<ResponsabileEnte> orderByComparator)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {
	 ...
	 * @return the first matching responsabile ente, or <code>null</code> if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<ResponsabileEnte> orderByComparator) {
	 ...
	 * @throws NoSuchResponsabileEnteException if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<ResponsabileEnte> orderByComparator)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {
	 ...
	 * @return the last matching responsabile ente, or <code>null</code> if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<ResponsabileEnte> orderByComparator) {
	 ...
	 * @throws NoSuchResponsabileEnteException if a responsabile ente with the primary key could not be found
	 */
	public static ResponsabileEnte[] findByUuid_C_PrevAndNext(
		...
		return getPersistence().findByUuid_C_PrevAndNext(
			responsabileEnteId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching responsabile entes
	 */
	public static List<ResponsabileEnte> findByEnteId(long enteId) {
		return getPersistence().findByEnteId(enteId);
	}
	 ...
	 * @return the range of matching responsabile entes
	 */
	public static List<ResponsabileEnte> findByEnteId(
		long enteId, int start, int end) {

		return getPersistence().findByEnteId(enteId, start, end);
	}
	...
	public static List<ResponsabileEnte> findByEnteId(
		...
		return getPersistence().findByEnteId(
			enteId, start, end, orderByComparator);
	}
	...
	public static List<ResponsabileEnte> findByEnteId(
		...
		return getPersistence().findByEnteId(
			enteId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchResponsabileEnteException if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte findByEnteId_First(
			long enteId, OrderByComparator<ResponsabileEnte> orderByComparator)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {

		return getPersistence().findByEnteId_First(enteId, orderByComparator);
	}
	 ...
	 * @return the first matching responsabile ente, or <code>null</code> if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte fetchByEnteId_First(
		long enteId, OrderByComparator<ResponsabileEnte> orderByComparator) {

		return getPersistence().fetchByEnteId_First(enteId, orderByComparator);
	}
	 ...
	 * @throws NoSuchResponsabileEnteException if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte findByEnteId_Last(
			long enteId, OrderByComparator<ResponsabileEnte> orderByComparator)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {

		return getPersistence().findByEnteId_Last(enteId, orderByComparator);
	}
	 ...
	 * @return the last matching responsabile ente, or <code>null</code> if a matching responsabile ente could not be found
	 */
	public static ResponsabileEnte fetchByEnteId_Last(
		long enteId, OrderByComparator<ResponsabileEnte> orderByComparator) {

		return getPersistence().fetchByEnteId_Last(enteId, orderByComparator);
	}
	 ...
	 * @throws NoSuchResponsabileEnteException if a responsabile ente with the primary key could not be found
	 */
	public static ResponsabileEnte[] findByEnteId_PrevAndNext(
			long responsabileEnteId, long enteId,
			OrderByComparator<ResponsabileEnte> orderByComparator)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {

		return getPersistence().findByEnteId_PrevAndNext(
			responsabileEnteId, enteId, orderByComparator);
	}
	 ...
	 * @param enteId the ente ID
	 */
	public static void removeByEnteId(long enteId) {
		getPersistence().removeByEnteId(enteId);
	}
	 ...
	 * @return the number of matching responsabile entes
	 */
	public static int countByEnteId(long enteId) {
		return getPersistence().countByEnteId(enteId);
	}
	 ...
	 */
	public static void cacheResult(ResponsabileEnte responsabileEnte) {
		getPersistence().cacheResult(responsabileEnte);
	}
	 ...
	 */
	public static void cacheResult(List<ResponsabileEnte> responsabileEntes) {
		getPersistence().cacheResult(responsabileEntes);
	}
	 ...
	 */
	public static ResponsabileEnte create(long responsabileEnteId) {
		return getPersistence().create(responsabileEnteId);
	}
	 ...
	 * @throws NoSuchResponsabileEnteException if a responsabile ente with the primary key could not be found
	 */
	public static ResponsabileEnte remove(long responsabileEnteId)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {

		return getPersistence().remove(responsabileEnteId);
	}

	public static ResponsabileEnte updateImpl(
		ResponsabileEnte responsabileEnte) {

		return getPersistence().updateImpl(responsabileEnte);
	}
	 ...
	 * @throws NoSuchResponsabileEnteException if a responsabile ente with the primary key could not be found
	 */
	public static ResponsabileEnte findByPrimaryKey(long responsabileEnteId)
		throws it.servizidigitali.accreditamentoenti.exception.
			NoSuchResponsabileEnteException {

		return getPersistence().findByPrimaryKey(responsabileEnteId);
	}
	 ...
	 */
	public static ResponsabileEnte fetchByPrimaryKey(long responsabileEnteId) {
		return getPersistence().fetchByPrimaryKey(responsabileEnteId);
	}
	 ...
	 */
	public static List<ResponsabileEnte> findAll() {
	 ...
	 */
	public static List<ResponsabileEnte> findAll(int start, int end) {
	...
	public static ResponsabileEntePersistence getPersistence() {
		return _persistence;
	}

	private static volatile ResponsabileEntePersistence _persistence;
