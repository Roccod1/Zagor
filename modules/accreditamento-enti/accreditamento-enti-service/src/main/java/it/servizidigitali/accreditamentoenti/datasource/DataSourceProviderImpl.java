package it.servizidigitali.accreditamentoenti.datasource;
...
public class DataSourceProviderImpl implements DataSourceProvider {
	...
	public DataSource getDataSource() {
		...
		try {
			...
			dataSource = DataSourceFactoryUtil.initDataSource(PropsUtil.getProperties("jdbc.accreditamentoenti.", true));
