 ...
 * @generated
 */
public abstract class ProceduraFinderBaseImpl
	extends BasePersistenceImpl<Procedura> {

	public ProceduraFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return proceduraPersistence.getBadColumnNames();
	}
