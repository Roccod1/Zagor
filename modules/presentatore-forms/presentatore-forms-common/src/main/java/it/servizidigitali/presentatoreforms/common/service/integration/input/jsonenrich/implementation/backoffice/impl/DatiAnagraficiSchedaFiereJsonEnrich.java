 ...
 *
 */
@Component(name = "datiAnagraficiSchedaFiereJsonEnrich", immediate = true, service = DatiAnagraficiJsonEnrich.class)
public class DatiAnagraficiSchedaFiereJsonEnrich implements DatiAnagraficiJsonEnrich {

	private static final Log log = LogFactoryUtil.getLog(DatiAnagraficiSchedaFiereJsonEnrich.class.getName());
	...
	public final String type = "datiAnagraficiFiere";
				...
				if (fieldNamesDataContainer != null) {
					...
					for (String fieldNameDataContainer : fieldNamesDataContainer) {
						...
						if (fieldDataContainer != null) {
							...
							if (!Validator.isBlank(codiceIstatComuneNascita)) {
							...
							// Se il componente � nato in uno stato estero
							if (componente.getCodiceStatoEsteroNascita() != null || componente.getDescrizioneStatoEsteroNascita() != null) {
								...
								if (comuneEstero != null) {
									...
									//fieldDataContainer.addProperty("codiceComuneEsteroNascitaHidden", comuneEstero.getCodice().toString());
								}
								else {
							...
							if (!Validator.isBlank(indirizzo)) {

								//fieldDataContainer.addProperty("viaHidden", indirizzo);
								...
								/*	if (denominazioneComuneRes != null) {
									...
									fieldDataContainer.addProperty("via", indirizzo + " - " + CAPResidenza + denominazioneComuneRes + siglaProvinciaRes);
									fieldDataContainer.addProperty("civico", numeroCivico + esponente + scala + piano + interno);
