 ...
 *
 */
@Component(name = "anagrafeTariDomesticaJsonEnrich", immediate = true, service = DatiAnagraficiJsonEnrich.class)
public class AnagrafeTariDomesticaJsonEnrich implements DatiAnagraficiJsonEnrich {

	public final String type = "anagrafeTariDomesticaCompleto";
	public final String typeNoStradario = "anagrafeTariDomesticaCompletoNoStradario";
