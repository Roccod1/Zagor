var datiAnagraficiCustomTwoColContainer = ' \
...
<script type="text/x-handlebars-template"> \
    <div data-disable-interaction-custom-field="true"> \
		...
		<div class="row"> \
			...
			<div>{{#with items.[6]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[7]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[8]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[9]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[10]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[11]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[12]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[13]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[14]}}{{#item}}{{/item}}{{/with}}</div> \
			<div>{{#with items.[15]}}{{#item}}{{/item}}{{/with}}</div> \
    </div> \
</script>';
