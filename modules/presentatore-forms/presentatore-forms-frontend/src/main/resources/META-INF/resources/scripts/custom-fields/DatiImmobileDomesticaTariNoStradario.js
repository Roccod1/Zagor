var datiImmobileDomesticaTariNoStradarioContainer = ' \
...
var datiImmobileDomesticaTariNoStradarioContainerObject = ' \
<script type="text/x-handlebars-template"> \
    <div> \
		<div class="row"> \
...
(function($) {
     ...
     */
    {
        ...
        getFieldType: function() {
            return "datiImmobileDomesticaTariNoStradario";
        },
        ...
        setup: function() {
            ...
            Alpaca.merge(this.options, {
            	...
            	"view": "immobiledomesticatariNoStradario-view"
            });
    ...
    Alpaca.registerFieldClass("datiImmobileDomesticaTariNoStradario", Alpaca.Fields.DatiImmobileDomesticaIscrizioneField); 
    
    Alpaca.registerView({
        "id": "immobiledomesticatariNoStradario-view",
        ...
        "templates": {
        	"container": datiImmobileDomesticaTariNoStradarioContainer,
        	"container-object": datiImmobileDomesticaTariNoStradarioContainerObject
        }
    });

    Alpaca.registerMessages({
        "addItemButtonLabel": "Aggiungi Immobile"
    }, "immobiledomesticatariNoStradario-view");
