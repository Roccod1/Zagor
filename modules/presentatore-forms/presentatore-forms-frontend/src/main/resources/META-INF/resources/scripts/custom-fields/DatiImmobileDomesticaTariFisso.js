var immobiledomesticatarifissoContainer = ' \
...
var immobiledomesticatarifissoContainerObject = ' \
<script type="text/x-handlebars-template"> \
    <div> \
	<div class="row"> \
...
(function($) {
    ...
    Alpaca.Fields.immobiledomesticatarifisso = Alpaca.Fields.ObjectField.extend(
    /**
     * @lends Alpaca.Fields.immobiledomesticatarifisso.prototype
     */
    {
        /**
        ...
        getFieldType: function() {
            return "immobiledomesticatarifisso";
        },
        ...
        setup: function()
        {
            ...
            Alpaca.merge(this.options, {
                ...
                "view": "immobiledomesticatarifisso-view"
            });
         ...
         */
        getTitle: function() {
            return "Dati immobile tari (domestica) Fisso";
        },
    ...
    Alpaca.registerView({
    	"id": "immobiledomesticatarifisso-view",
    	"parent": "bootstrap-create",
    	"templates": {
    		"container": immobiledomesticatarifissoContainer,
    		"container-object": immobiledomesticatarifissoContainerObject
    	}
    });
    Alpaca.registerFieldClass("immobiledomesticatarifisso", Alpaca.Fields.immobiledomesticatarifisso);
