var anagrafeTariDomesticaCompletoNoStradarioContainer = ' \
...
var anagrafeTariDomesticaCompletoNoStradarioContainerObject = ' \
<script type="text/x-handlebars-template"> \
    <div data-disable-interaction-custom-field="true"> \
		...
		<div class="row"> \
			<div class="col-md-8">{{#with items.[14]}}{{#item}}{{/item}}{{/with}}</div> \
		</div> \
		<div class="row"> \
		...
		<div class="row"> \
			...
			<div class="col-md-4">{{#with items.[39]}}{{#item}}{{/item}}{{/with}}</div> \
			<div class="col-md-4">{{#with items.[40]}}{{#item}}{{/item}}{{/with}}</div> \
		</div> \
		<div class="row"> \
			<div class="col-md-4">{{#with items.[41]}}{{#item}}{{/item}}{{/with}}</div> \
			<div class="col-md-4">{{#with items.[42]}}{{#item}}{{/item}}{{/with}}</div> \
			<div class="col-md-4">{{#with items.[43]}}{{#item}}{{/item}}{{/with}}</div> \
		</div> \
    </div> \
</script>';
...
(function($) {
    ...
    Alpaca.Fields.anagrafeTariDomesticaCompletoNoStradario = Alpaca.Fields.ObjectField.extend(
    /**
     * @lends Alpaca.Fields.anagrafeTariDomesticaCompletoNoStradario.prototype
     */
    {
        /**
        ...
        getFieldType: function() {
            return "anagrafeTariDomesticaCompletoNoStradario";
        },
        ...
        setup: function()
        {
            ...
            Alpaca.merge(this.options, {
                ...
                "view": "anagrafeTariDomesticaCompletoNoStradario-view"
            });
         ...
         */
        getTitle: function() {
            return "Anagrafe Tari domestica completo no stradario";
        },
        ...
        getDescription: function() {
            return "Anagrafe Tari domestica completo senza stradario";
        }
    });

    Alpaca.registerView({
    	"id": "anagrafeTariDomesticaCompletoNoStradario-view",
    	"parent": "bootstrap-create",
    	"templates": {
    		"container": anagrafeTariDomesticaCompletoNoStradarioContainer,
    		"container-object": anagrafeTariDomesticaCompletoNoStradarioContainerObject
    	}
    });
    Alpaca.registerFieldClass("anagrafeTariDomesticaCompletoNoStradario", Alpaca.Fields.anagrafeTariDomesticaCompletoNoStradario);
