...
public class SecurityAccessFilter implements RenderFilter {
	...
	public void doFilter(RenderRequest request, RenderResponse response, FilterChain chain) throws IOException, PortletException {
		...
		//
		// ServizioEnte servizioEnte =
		// servizioEnteLocalService.getServizioEnteByGroupIdLayoutId(groupId, layoutId);
		//
		...
		// log.debug("Servizio non attivo :: servizioId: " + servizioEnte.getServizioId() + ",
		...
		// log.debug("Il servizio richiede autenticazione ma l'utente non è loggato :: servizioId: "
		// + servizioEnte.getServizioId() + ", organizationId: " +
		// servizioEnte.getOrganizationId());
		// // TODO testare
		// throw new SecurityException("");
		// }
		//
		...
		// log.debug("Livello SPID non sufficiente per accedere al servizio :: servizioId: " +
		// servizioEnte.getServizioId() + ", organizationId: " + servizioEnte.getOrganizationId()
		// + ", livelloSpidUser: " + livelloSpidUser + ", livelloAutenticazione: " +
		// servizioEnte.getLivelloAutenticazione());
