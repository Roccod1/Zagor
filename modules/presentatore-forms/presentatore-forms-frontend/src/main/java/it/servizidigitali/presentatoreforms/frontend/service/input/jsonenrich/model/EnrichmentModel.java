...
public class EnrichmentModel<T> {
	 ...
	 *
	 */
	public EnrichmentModel(AlpacaJsonOptionsStructure alpacaJsonOptionsStructure, JsonObject alpacaJsonData, T sourceObject, Long organizationId, Long servizioId) {
